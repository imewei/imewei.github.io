...
### Jekyll / Liquid
- All CSS lives in `assets/css/base.css`; use existing CSS custom properties defined in `:root`.
- Page-specific styles use `.page--{slug}` selectors.
- Homepage styles prefixed with `.home-`.
- Reference images with absolute paths (`/assets/img/...`), never relative.
